                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Selamat datang kembali! Berikut perkembangan inventaris Anda hari ini.</p>
                        </div>
                    </div>
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd class="flex items-baseline">
                                                <div class="text-2xl font-semibold text-gray-900">{{ $totalItems }}
                                                </div>
                                            </dd>
                                        </dl>
                                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-500 truncate">Total Kategori
                                            </dt>
                                            <dd class="flex items-baseline">
                        ...
                        <div class="bg-white overflow-hidden shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-500 truncate">Barang Stok Rendah</dt>
                                            <dd class="flex items-baseline">
                                                <div class="text-2xl font-semibold text-gray-900">{{ $lowStockItems }}
                                                </div>
                                            </dd>
                                        </dl>
                                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-500 truncate">Total Nilai Barang</dt>
                                            <dd class="flex items-baseline">
                                                <div class="text-2xl font-semibold text-gray-900">Rp {{ number_format($inventoryValue, 0, ',', '.') }}</div>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2">
                            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Aktivitas Terkini</h3>
                                    <p class="mt-1 text-sm text-gray-500">Perubahan Terbaru pada Inventaris Anda</p>
                                </div>
                                        ...
                                        <div class="px-4 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <div
                                                    ...
                                                    <i class="fas fa-{{ $activity['icon'] }} text-indigo-600"></i>
                                                </div>
                                                <div class="ml-4">
                        ...
                        <div>
                            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Tindakan Cepat</h3>
                                    <p class="mt-1 text-sm text-gray-500">Tindakan yang Sering Digunakan</p>
                                </div>
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-1 gap-4">
                                        ...
                                        <a href="{{ route('items.index') }}?filter=low_stock"
                                            ...
                                            <i class="fas fa-exclamation-triangle mr-2"></i> Lihat Stock Rendah
                                        </a>
                                    </div>
                                </div>
                            </div>
